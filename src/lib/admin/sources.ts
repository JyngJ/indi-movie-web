...
export const ADMIN_THEATER_SOURCES: AdminTheaterSource[] = [
  ...
  // ── Dtryx 외 자체예매 (selfHosted parser) ────────────────────────

  {
    id: 'src-gangneung-sinnyeong-selfhosted',
    theaterId: '',
    theaterName: '강릉독립예술극장 신영',
    homepageUrl: 'http://www.gncine.kr',
    listingUrl: 'http://www.gncine.kr/31',
    parser: 'selfHosted',
    enabled: false,
    cadence: 'daily',
    health: 'degraded',
    notes: 'imweb.me 캘린더(JS 렌더링) + tinyticket.net 예매. selfHosted 파서에 gncine.kr 구현 필요.',
  },
  {
    id: 'src-sangsangmadang-chuncheon-selfhosted',
    theaterId: '',
    ...
    cadence: 'daily',
    health: 'degraded',
    notes: 'SPA, 데이터 AJAX 로드. selfHosted 파서에 sangsangmadang.com 구현 필요.',
  },
  {
    id: 'src-picturehouse-selfhosted',
    theaterId: '',
    theaterName: '픽쳐하우스',
    homepageUrl: 'https://picturehouse.moonhwain.kr:447',
    listingUrl: 'https://picturehouse.moonhwain.kr:447/reservation/01.html',
    parser: 'selfHosted',
    enabled: true,
    cadence: 'daily',
    health: 'healthy',
  ...
  {
    id: 'src-gift-gwangju-selfhosted',
    theaterId: '',
    theaterName: '광주독립영화관',
    homepageUrl: 'http://gift4u.or.kr',
    listingUrl: 'https://moviee.co.kr/Theater/Index?thsynid=128',
    parser: 'selfHosted',
    enabled: true,
    cadence: 'daily',
    health: 'healthy',
    notes: 'gift4u.or.kr은 movieee(thsynid=128) 사용. selfHosted → movieeTicketApi 자동 위임.',
  },
  {
    id: 'src-jcinema-jeonju-selfhosted',
    theaterId: '',
    theaterName: '전주 시네마타운',
    homepageUrl: 'https://jcinema.moonhwain.net:451',
    listingUrl: 'https://jcinema.moonhwain.net:451/reservation/01.html',
    parser: 'selfHosted',
    enabled: true,
    cadence: 'daily',
    health: 'healthy',
  ...
  {
    id: 'src-joyn-jeonju-selfhosted',
    theaterId: '',
    theaterName: '조이앤시네마 전주',
    homepageUrl: 'https://joyn.moonhwain.net:451',
    listingUrl: 'https://joyn.moonhwain.net:451/reservation/01.html',
    parser: 'selfHosted',
    enabled: true,
    cadence: 'daily',
    health: 'healthy',
  ...
  {
    id: 'src-dureraum-busan-selfhosted',
    theaterId: '',
    theaterName: '영화의전당',
    homepageUrl: 'https://www.dureraum.org',
    listingUrl: 'https://www.dureraum.org/bcc/mcontents/caleList.do?rbsIdx=37',
    parser: 'selfHosted',
    enabled: true,
    cadence: 'daily',
    health: 'healthy',
