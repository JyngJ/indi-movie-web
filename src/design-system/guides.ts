...
export const GUIDES: Record<string, ComponentGuide> = {
  ...
  PosterChip: {
    ...
    specs: [
      ...
      { title: '판별 질문', desc: '위 순서도대로 두 질문을 차례로 묻습니다. 값을 정하는 데 필요한 것 — 개봉 주년: 영화 연도·올해 · 막바지 D-N: 영화·오늘 · 매진: 회차 · 회차 시각: 극장·회차 · GV 유형: GV 행사 · 거리: 극장·사용자 위치.' },
      ...
      { title: '자리와 우선순위', desc: '코너 태그는 좌상단 한 자리에만 둡니다. 우상단은 관심 하트 자리이고, 위쪽 두 모서리를 모두 막으면 포스터가 무거워집니다. 막바지 D-N과 개봉 주년이 한 포스터에 겹치면 D-N을 보여 줍니다 — D-N은 날짜가 지나면 사라져 놓치면 되돌릴 수 없고, 주년은 다른 섹션에서도 계속 붙습니다.' },
