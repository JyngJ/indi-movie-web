...
/** 프로필 · 계정 관리 본문 (IA 29) — 모바일 /my/profile 페이지와 데스크톱 MyPanel이 공유. onDone: 로그아웃/탈퇴/비로그인 시 복귀 */
export function ProfileContent({ onDone }: { onDone: () => void }) {
