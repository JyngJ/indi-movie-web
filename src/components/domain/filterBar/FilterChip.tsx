...
export function FilterChip({ label, value, open, selected, hasDropdown, onClick, onClear, chipRef, separator = '·', rc }: FilterChipProps) {
  /* 2.0/FilterPill 정합 (2026-08-09 정정): off = neutral/100 + neutral/300 보더, on = primary/100 + 700 */
  let bg = 'var(--color-surface-bg)'
  let border = '1px solid var(--color-neutral-300)'
  let pl = '14px'
