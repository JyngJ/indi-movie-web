    ...
    <PanelShell onClose={onClose} onBack={onBack} embedded={embedded} title={movie.title}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0, paddingTop: 4 }}>
          ...
          <div style={{ marginTop: 12, fontSize: 13, color: 'var(--color-text-sub)', lineHeight: 1.5 }}>
      ...
      <FavoriteActionRow type="movie" id={movie.id} style={{ padding: '0 var(--gutter) 16px', background: 'var(--color-surface-card)' }} />
            ...
            {group.showtimes.map((st) => {
              ...
              return (
                <button
                  ...
                  style={{ padding: '8px 12px', borderRadius: 8, border: '1px solid var(--color-border)', backgroundColor: 'var(--color-surface-raised)', cursor: soldout ? 'default' : 'pointer', opacity: soldout ? 0.5 : 1, textAlign: 'left', minHeight: 'auto' }}
                >
