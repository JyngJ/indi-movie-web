...
// force-dynamic이라 페이지 자체는 캐싱 대상이 아니지만, DB 조회만은 unstable_cache로
// 캐싱한다 — 안 그러면 generateMetadata·페이지 컴포넌트 양쪽에서 부르는 fetchMovie가
// 방문마다 매번 2번씩(!) Supabase를 침. (2026-08 movies 테이블 요청 폭주의 원인.)
