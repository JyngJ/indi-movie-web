...
ALTER TABLE curation_pending ADD COLUMN IF NOT EXISTS last_week_films JSONB NOT NULL DEFAULT '[]'::jsonb;
ALTER TABLE curation_pending ADD COLUMN IF NOT EXISTS solo_theater_films JSONB NOT NULL DEFAULT '{}'::jsonb;
