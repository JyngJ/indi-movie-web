...
files = glob.glob("src/components/domain/*Sheet.tsx") + \
        glob.glob("src/components/domain/*Panel*.tsx") + \
        glob.glob("src/components/domain/desktopDetailPanel/*.tsx") + \
        glob.glob("src/components/primitives/*Sheet.tsx") + \
        glob.glob("src/components/map/*Panel.tsx")
