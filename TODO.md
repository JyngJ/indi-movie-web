...
### 데이터
- ✅ 포스터 채우기 실행 완료 (2026-05-29)
  - KMDB: 25개 모두 미제공
  - Wikipedia: 14개 저장, 11개 여전히 없음
  - [ ] 수동 포스터 필요 (11개): 군락, 기억 저편의 장소, 다윗, 레네트와 미라벨의 네 가지 모험, 마이클 잭슨 데인저러스, 원더(2024), 원한의 도곡리 다리, 인플루엔자, 진달래 꽃을 좋아합니다, 하이 눈, 간만에 나온 종각 이
- [ ] 극장 좌표 검증 (일부 임의값)
- [ ] 극장 인스타그램 미확인 17개 보정
